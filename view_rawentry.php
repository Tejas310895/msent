                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $counter = 0;
                                while ($row_entry = mysqli_fetch_array($run_entry, MYSQLI_ASSOC)) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ajaxphp/ajaxhelper.php?delete_purchase=<?php echo $row_entry['entry_id']; ?>" class="btn btn-danger text-center p-2">
